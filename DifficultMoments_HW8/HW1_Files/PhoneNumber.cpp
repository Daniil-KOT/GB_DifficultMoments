...
bool operator==(PhoneNumber cur, PhoneNumber other)
{
	return std::tie(cur.countryCode_, cur.cityCode_, cur.number_, cur.additionalNumber_)
		== std::tie(other.countryCode_, other.cityCode_, other.number_, other.additionalNumber_);
}
